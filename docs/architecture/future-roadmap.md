...
- **Notifications** — new `notifications` collection + a delivery service (email/push), triggered from existing service methods via events, not embedded inline in unrelated services.
